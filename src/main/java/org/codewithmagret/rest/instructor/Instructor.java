...
public class Instructor {
     ...
     * This field is automatically generated by the database and serves as the primary key for the instructor.
     */
    @Id
     ...
     * This field is required and represents the instructor's given name.
     */
    private String firstName;

    /**
     * The last name of the instructor.
     * This field is required and represents the instructor's family name.
     */
    private String lastName;

    /**
     * The email address of the instructor.
     * This field is required and must be unique across all instructors to prevent duplicates.
     * It can be used as a contact point for the instructor and may also serve as a username for authentication purposes.
     */
    private String email;

    /**
     * One instructor can teach many courses. The Course entity owns this relationship.
     * The `mappedBy` attribute indicates that the `instructor` field in the Course entity is responsible for managing this relationship.
     * The @JsonIgnore annotation is used to prevent infinite recursion during JSON serialization, as the Course entity also references the Instructor.
     */
    @JsonIgnore
